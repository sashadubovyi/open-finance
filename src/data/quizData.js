...
const goalStep = {
  ...
  options: [
    { label: '$100 – $400', hint: 'Чисто на карманные расходы' },
    { label: '$400 – $900', hint: 'Ощутимая прибавка к доходу' },
    { label: '$900 – $1,500', hint: 'Для покупки авто и путешествий' },
    { label: 'От $1,500+', hint: 'Хочу ни в чем себе не отказывать' },
  ],
}
...
const yieldStep = {
  ...
  options: [
    ...
    { label: '520% годовых', hint: 'Быстрый разгон капитала на горячих трендах и золоте', value: 520 },
